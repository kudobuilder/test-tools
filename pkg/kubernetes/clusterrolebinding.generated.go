...
func (clusterrolebinding ClusterRoleBinding) Delete() error {
	...
	err := clusterrolebinding.client.Kubernetes.
		RbacV1().
		ClusterRoleBindings().
		Delete(context.TODO(), clusterrolebinding.Name, options)
	if err != nil {
...
func (clusterrolebinding *ClusterRoleBinding) Update() error {
	...
	update, err := clusterrolebinding.client.Kubernetes.
		RbacV1().
		ClusterRoleBindings().
		Get(context.TODO(), clusterrolebinding.Name, options)
	if err != nil {
...
func (clusterrolebinding *ClusterRoleBinding) Save() error {
	update, err := clusterrolebinding.client.Kubernetes.
		RbacV1().
		ClusterRoleBindings().
		Update(context.TODO(), &clusterrolebinding.ClusterRoleBinding, metav1.UpdateOptions{})
	if err != nil {
